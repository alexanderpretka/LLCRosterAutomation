...
Sub CreateLLCRosters()
    ...
    fileNames = Array( _
        ...
        "LLC_BIOME_Roster.xlsx", "LLC_BASH_Roster.xlsx", "LLC_EMS_Roster.xlsx", _
        "LLC_EARTH_Roster.xlsx", "LLC_ED_EQUITY_Roster.xlsx", "LLC_EHOUSE_Roster.xlsx", "LLC_FY_COMM_Roster.xlsx", _
...
' Apply filter for "LLC_FY_COMM_Roster.xlsx" file
If fileNames(i) = "LLC_FY_COMM_Roster.xlsx" Then
